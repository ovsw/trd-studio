...
import { FaRegNewspaper, FaRegStar, FaFile, FaUniversity, FaBook} from "react-icons/fa";
...
const hiddenDocTypes = listItem =>
  !['siteSettings', 'newsItem', 'attraction', 'page', 'post', 'reusableSection', 'event', 'sponsor', 'siteHome', 'course', 'workshop', 'courseSession', 'staffMember', 'testimonial'].includes(listItem.getId())
